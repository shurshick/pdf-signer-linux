...
Depends: libc6, libgl1 | libgl1-mesa-glx | libGL, libglib2.0-0, libx11-6, libxcb1, libxcb-xinerama0, libxcb-icccm4, libxcb-image0, libxcb-keysyms1, libxcb-randr0, libxcb-render-util0, libxcb-shape0, libxkbcommon0, libxkbcommon-x11-0
